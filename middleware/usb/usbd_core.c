...
TaskHandle_t USBD_RTOS_DevTask    = NULL;           /* USB Device Task ID */
TaskHandle_t USBD_RTOS_EPTask[16] = {NULL};         /* USB Endpoint Task ID's */
TaskHandle_t USBD_RTOS_CoreTask   = NULL;           /* USB Core Task ID */
#endif
 ...
 *   Called by the User to check if USB Device is configured
 *    Parameters:
            ...
            switch (USBD_SetupPacket.wValueH) {
                ...
                case USB_STRING_DESCRIPTOR_TYPE:
                    ...
                    if (USBD_SetupPacket.wValueL == 3) {
                        ...
                        USBD_EP0Data.pData = "JiCheng_I.MXRT";
            ...
            case REQUEST_STANDARD:
                switch (USBD_SetupPacket.bRequest) {
                    ...
                    case USB_REQUEST_CLEAR_FEATURE:
                        ...
                        if (__rtx) {
                            if (USBD_RTOS_CoreTask) {
                                xTaskNotify(USBD_RTOS_CoreTask, USBD_EVT_CLR_FEATURE, eSetBits);
                            }
                        } else {
#endif
                    ...
                    case USB_REQUEST_SET_FEATURE:
                        ...
                        if (__rtx) {
                            if (USBD_RTOS_CoreTask) {
                                xTaskNotify(USBD_RTOS_CoreTask, USBD_EVT_SET_FEATURE, eSetBits);
                            }
                        } else {
#endif
                    ...
                    case USB_REQUEST_SET_CONFIGURATION:
                        ...
                        if (__rtx) {
                            if (USBD_RTOS_CoreTask) {
                                xTaskNotify(USBD_RTOS_CoreTask, USBD_EVT_SET_CFG, eSetBits);
                            }
                        } else {
#endif
                    ...
                    case USB_REQUEST_SET_INTERFACE:
                        ...
                        if (__rtx) {
                            if (USBD_RTOS_CoreTask) {
                                xTaskNotify(USBD_RTOS_CoreTask, USBD_EVT_SET_IF, eSetBits);
                            }
                        } else {
#endif
...
#ifdef USBSTACK_RTOS_FREE_RTOS
void USBD_RTOS_EndPoint0(void)
{
    for (;;) {
        USBD_EndPoint0(ulTaskNotifyTake(pdTRUE, portMAX_DELAY));
    }
}
#endif
