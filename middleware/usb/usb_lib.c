...
#define USBD_RTOS_DEVICE_PRIORITY        configMAX_PRIORITIES-5
#define USBD_RTOS_CORE_PRIORITY          configMAX_PRIORITIES-4
#define USBD_RTOS_ENDPOINT0_PRIORITY     configMAX_PRIORITIES-3
#endif
/*------------------------------------------------------------------------------
...
#if    (USBD_HID_ENABLE)
#ifndef USBSTACK_RTOS_FREE_RTOS
...
#define USBD_RTOS_EndPoint1             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_HID_EP_INTIN_Event
#elif  (USBD_HID_EP_INTIN == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_HID_EP_INTIN_Event
#endif

#if    (USBD_HID_EP_INTOUT == 1)
#define USBD_RTOS_EndPoint1             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_HID_EP_INTOUT_Event
#elif  (USBD_HID_EP_INTOUT == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_HID_EP_INTOUT_Event
#endif
#elif    (USBD_HID_EP_INTOUT != 0)
#if    (USBD_HID_EP_INTIN == 1)
#define USBD_RTOS_EndPoint1             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_HID_EP_INT_Event
#elif  (USBD_HID_EP_INTIN == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_HID_EP_INT_Event
#endif
#else
#if    (USBD_HID_EP_INTIN == 1)
#define USBD_RTOS_EndPoint1             USBD_RTOS_HID_EP_INTIN_Event
...
#define USBD_RTOS_EndPoint1             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_MSC_EP_BULKIN_Event
#elif  (USBD_MSC_EP_BULKIN == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_MSC_EP_BULKIN_Event
#endif

#if    (USBD_MSC_EP_BULKOUT == 1)
#define USBD_RTOS_EndPoint1             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_MSC_EP_BULKOUT_Event
#elif  (USBD_MSC_EP_BULKOUT == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_MSC_EP_BULKOUT_Event
#endif
#else
#if    (USBD_MSC_EP_BULKIN == 1)
#define USBD_RTOS_EndPoint1             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_MSC_EP_BULK_Event
#elif  (USBD_MSC_EP_BULKIN == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_MSC_EP_BULK_Event
#endif
#endif
#else
#if    (USBD_MSC_EP_BULKIN != USBD_MSC_EP_BULKOUT)
...
#define USBD_RTOS_EndPoint1               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 2)
#define USBD_RTOS_EndPoint2               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 3)
#define USBD_RTOS_EndPoint3               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 4)
#define USBD_RTOS_EndPoint4               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 5)
#define USBD_RTOS_EndPoint5               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 6)
#define USBD_RTOS_EndPoint6               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 7)
#define USBD_RTOS_EndPoint7               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 8)
#define USBD_RTOS_EndPoint8               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 9)
#define USBD_RTOS_EndPoint9               USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 10)
#define USBD_RTOS_EndPoint10              USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 11)
#define USBD_RTOS_EndPoint11              USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 12)
#define USBD_RTOS_EndPoint12              USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 13)
#define USBD_RTOS_EndPoint13              USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 14)
#define USBD_RTOS_EndPoint14              USBD_RTOS_CDC_ACM_EP_INTIN_Event
#elif  (USBD_CDC_ACM_EP_INTIN == 15)
#define USBD_RTOS_EndPoint15              USBD_RTOS_CDC_ACM_EP_INTIN_Event
#endif
#else
#if    (USBD_CDC_ACM_EP_INTIN == 1)
...
#define USBD_RTOS_EndPoint1             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_CDC_ACM_EP_BULKIN_Event
#endif

#if    (USBD_CDC_ACM_EP_BULKOUT == 1)
#define USBD_RTOS_EndPoint1             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#elif  (USBD_CDC_ACM_EP_BULKOUT == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_CDC_ACM_EP_BULKOUT_Event
#endif
#else
#if    (USBD_CDC_ACM_EP_BULKIN == 1)
#define USBD_RTOS_EndPoint1             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 2)
#define USBD_RTOS_EndPoint2             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 3)
#define USBD_RTOS_EndPoint3             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 4)
#define USBD_RTOS_EndPoint4             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 5)
#define USBD_RTOS_EndPoint5             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 6)
#define USBD_RTOS_EndPoint6             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 7)
#define USBD_RTOS_EndPoint7             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 8)
#define USBD_RTOS_EndPoint8             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 9)
#define USBD_RTOS_EndPoint9             USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 10)
#define USBD_RTOS_EndPoint10            USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 11)
#define USBD_RTOS_EndPoint11            USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 12)
#define USBD_RTOS_EndPoint12            USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 13)
#define USBD_RTOS_EndPoint13            USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 14)
#define USBD_RTOS_EndPoint14            USBD_RTOS_CDC_ACM_EP_BULK_Event
#elif  (USBD_CDC_ACM_EP_BULKIN == 15)
#define USBD_RTOS_EndPoint15            USBD_RTOS_CDC_ACM_EP_BULK_Event
#endif
#endif
#else
#if    (USBD_CDC_ACM_EP_BULKIN != USBD_CDC_ACM_EP_BULKOUT)
...
#if   ((USBD_HID_ENABLE) || (USBD_ADC_ENABLE) || (USBD_CDC_ACM_ENABLE) || (USBD_CLS_ENABLE))
__weak void USBD_RTOS_Device(void)
{
    U32 evt;

    for (;;) {
        evt = ulTaskNotifyTake(pdTRUE, portMAX_DELAY);/* Get Event Flags */
...
void (* const USBD_RTOS_P_Device)(void) = USBD_RTOS_Device;

/* USB Device Endpoint Events Callback Functions */
extern void USBD_RTOS_EndPoint0(void);
#ifndef       USBD_RTOS_EndPoint1
__weak void USBD_RTOS_EndPoint1(void);
#endif
#ifndef       USBD_RTOS_EndPoint2
__weak void USBD_RTOS_EndPoint2(void);
#endif
#ifndef       USBD_RTOS_EndPoint3
__weak void USBD_RTOS_EndPoint3(void);
#endif
#ifndef       USBD_RTOS_EndPoint4
__weak void USBD_RTOS_EndPoint4(void);
#endif
#ifndef       USBD_RTOS_EndPoint5
__weak void USBD_RTOS_EndPoint5(void);
#endif
#ifndef       USBD_RTOS_EndPoint6
__weak void USBD_RTOS_EndPoint6(void);
#endif
#ifndef       USBD_RTOS_EndPoint7
__weak void USBD_RTOS_EndPoint7(void);
#endif
#ifndef       USBD_RTOS_EndPoint8
__weak void USBD_RTOS_EndPoint8(void);
#endif
#ifndef       USBD_RTOS_EndPoint9
__weak void USBD_RTOS_EndPoint9(void);
#endif
#ifndef       USBD_RTOS_EndPoint10
__weak void USBD_RTOS_EndPoint10(void);
#endif
#ifndef       USBD_RTOS_EndPoint11
__weak void USBD_RTOS_EndPoint11(void);
#endif
#ifndef       USBD_RTOS_EndPoint12
__weak void USBD_RTOS_EndPoint12(void);
#endif
#ifndef       USBD_RTOS_EndPoint13
__weak void USBD_RTOS_EndPoint13(void);
#endif
#ifndef       USBD_RTOS_EndPoint14
__weak void USBD_RTOS_EndPoint14(void);
#endif
#ifndef       USBD_RTOS_EndPoint15
__weak void USBD_RTOS_EndPoint15(void);
#endif

#if    (USBD_HID_ENABLE)
__weak void USBD_RTOS_Core(void)
{
    U32 evt;
...
void (* const USBD_RTOS_P_Core)(void)  = USBD_RTOS_Core;

/* USB Device Endpoint Events Callback Pointers */
void (* const USBD_RTOS_P_EP[16])(void) = {
    USBD_RTOS_EndPoint0,
    USBD_RTOS_EndPoint1,
    USBD_RTOS_EndPoint2,
    USBD_RTOS_EndPoint3,
    ...
    USBD_RTOS_EndPoint8,
    USBD_RTOS_EndPoint9,
    USBD_RTOS_EndPoint10,
    USBD_RTOS_EndPoint11,
    USBD_RTOS_EndPoint12,
    USBD_RTOS_EndPoint13,
    USBD_RTOS_EndPoint14,
    USBD_RTOS_EndPoint15,
};
...
#if USBD_ENABLE && !defined(USBD_RTOS_CORE_STACK)
#error "USB core stack must be defined"
#endif
#if USBD_ENABLE && !defined(USBD_RTOS_DEVICE_STACK)
#error "USB device stack must be defined"
#endif
#if USBD_ENABLE && !defined(USBD_RTOS_ENDPOINT0_STACK)
...
#endif /* USBSTACK_RTOS_FREE_RTOS */

void USBD_RTOS_TaskInit(void)
{
#ifdef USBSTACK_RTOS_FREE_RTOS
    ...
    if (USBD_RTOS_P_Device) {
      if(pdPASS != xTaskCreate((TaskFunction_t)USBD_RTOS_Device, 
                                "USBD_RTOS_Device_Task", 
                                 USBD_RTOS_DEVICE_STACK, NULL, 
                                  USBD_RTOS_DEVICE_PRIORITY, 
                                  &USBD_RTOS_DevTask))
      {
        printf("Failed to creat USBD_RTOS_Device_Task!");
        return;
      }
      printf("USBD_RTOS_Device_Task is created!\r\n");
    }

    for (i = 0; i <= 15; i++) {
        USBD_RTOS_EPTask[i] = 0;
        ...
        if (USBD_RTOS_P_EP[i]) {
            ...
            char priority = ((0 == i) ? USBD_RTOS_ENDPOINT0_PRIORITY : (USBD_RTOS_ENDPOINT0_PRIORITY-1));
            char task_name[30];
            sprintf(task_name, "USBD_RTOS_Endpoint%d_Task", i);
            if(pdPASS != xTaskCreate((TaskFunction_t)USBD_RTOS_P_EP[i], 
                                      task_name,
                                       USBD_RTOS_ENDPOINT0_STACK,
                                        NULL,
                                         priority,
                                          &USBD_RTOS_EPTask[i]))
            {
              printf("Failed to creat USBD_RTOS_Endpoint%d_Task!", i);
              return;
            }
            printf("USBD_RTOS_Endpoint%d_Task is created!\r\n", i);
        }
    }

    USBD_RTOS_CoreTask = 0;

    if (USBD_RTOS_P_Core) {
      if(pdPASS != xTaskCreate((TaskFunction_t)USBD_RTOS_Core, 
                                "USBD_RTOS_Core_Task", 
                                 USBD_RTOS_CORE_STACK, NULL, 
                                  USBD_RTOS_CORE_PRIORITY, 
                                  &USBD_RTOS_CoreTask))
      {
        printf("Failed to creat USBD_RTOS_Core_Task!");
        return;
      }
      printf("USBD_RTOS_Core_Task is created!\r\n");
    }

#endif
}

void USBD_RTOS_TaskDeInit(void)
{
#ifdef USBSTACK_RTOS_FREE_RTOS
    /* Initialize memory pools for endpoints */
    U32 i;
    ...
    if (USBD_RTOS_P_Device) {
      if(USBD_RTOS_DevTask!=NULL)
      {
        vTaskDelete(USBD_RTOS_DevTask);
        printf("USBD_RTOS_Device_Task is deleted!\r\n");
      }
    }

    for (i = 0; i <= 15; i++) {
        if (USBD_RTOS_P_EP[i]) {
            if(USBD_RTOS_EPTask[i] != NULL)
            {
              vTaskDelete(USBD_RTOS_EPTask[i]);
              printf("USBD_RTOS_Endpoint%d_Task is Deleted!\r\n", i);
            }
        }
    }
    if (USBD_RTOS_P_Core) {
      if(USBD_RTOS_CoreTask != NULL)
      {
        vTaskDelete(USBD_RTOS_CoreTask);
        printf("USBD_RTOS_Core_Task is deleted!\r\n");
      }
    }
