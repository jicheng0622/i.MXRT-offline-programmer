...
void BOARD_InitPins(void) {
  ...
  PORT_SetPinMux(PORTE, 26u, kPORT_MuxAsGpio);               /* PTE26->GREEN LED */
  ...
  /* Host UART Interface */
  PORT_SetPinMux(PORTC, 14, kPORT_MuxAlt3);                  /* PORTC14 (pin 86) is configured as UART4_RX */
  PORT_SetPinMux(PORTC, 15, kPORT_MuxAlt3);                  /* PORTC15 (pin 87) is configured as UART4_TX */
  
  port_pin_config_t portc6_config = {
  ...
  PORT_SetPinConfig(PORTC, PIN6_IDX, &portc6_config);        /* PORTC6 is configured as Key SW2 */
