...
#define BOARD_DEBUG_UART_CLKSRC           UART0_CLK_SRC
#define BOARD_DEBUG_UART_IRQ              UART0_RX_TX_IRQn
#define BOARD_DEBUG_UART_IRQ_HANDLER      UART0_RX_TX_IRQHandler

#ifndef BOARD_DEBUG_UART_BAUDRATE
#define BOARD_DEBUG_UART_BAUDRATE         115200
#endif /* BOARD_DEBUG_UART_BAUDRATE */

/* The UART to use for Host Programming */
#define BOARD_HOST_UART_TYPE              kSerialPort_Uart
#define BOARD_HOST_UART_BASEADDR          UART4
#define BOARD_HOST_UART_INSTANCE          4U
#define BOARD_HOST_UART_CLKSRC            UART4_CLK_SRC
#define BOARD_HOST_UART_IRQ               UART4_RX_TX_IRQn
#define BOARD_HOST_UART_IRQ_HANDLER       UART4_RX_TX_IRQHandler

#ifndef BOARD_HOST_UART_BAUDRATE
#define BOARD_HOST_UART_BAUDRATE          115200
#endif /* BOARD_DEBUG_UART_BAUDRATE */
 ...
 * API
 ******************************************************************************/
extern uart_rtos_handle_t debug_uart_rtos_handler;
extern uart_handle_t debug_uart_handler;
