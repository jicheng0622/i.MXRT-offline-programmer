...
#define USBD_RTOS_CORE_STACK         200
#define USBD_RTOS_DEVICE_STACK       200
#define USBD_RTOS_ENDPOINT0_STACK    200
...
#define USBD_STRDESC_MAN            L"Jicheng0622"
#elif defined(__ICCARM__)
#define USBD_STRDESC_MAN            u"JiCheng0622"
#endif
#ifndef USB_PROD_STR
#if defined(__CC_ARM) || defined(__ARMCC_VERSION)
#define USBD_STRDESC_PROD           L"i.MXRT offline Programmer"
#elif defined(__ICCARM__)
#define USBD_STRDESC_PROD           u"i.MXRT offline Programmer"
#endif
#else
#if defined(__CC_ARM) || defined(__ARMCC_VERSION)
...
#elif defined(__ICCARM__)
#define USBD_HID_STRDESC            u"CMSIS-DAP"
...
#define USBD_MSC_EP_BULKIN_STACK    200
...
#define USBD_MSC_INQUIRY_DATA       "i.MXRT  "         \
                                    "Offline_Prog    " \
                                    "0.1"
